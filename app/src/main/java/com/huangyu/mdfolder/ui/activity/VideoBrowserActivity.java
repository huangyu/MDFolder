...
public class VideoBrowserActivity extends ThematicActivity implements EasyVideoCallback {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        mCurrentPosition = getIntent().getIntExtra(getString(R.string.intent_video_position), 0);
        mAdapter = new VideoPagerAdapter(this, mFileList, this);
...
//        mViewPager.setPageTransformer(true, new DepthPageTransformer());
    ...
    private void resetLastPositionPlayer() {
        View view = mViewPager.findViewWithTag("video" + mCurrentPosition);
        if (view != null) {
        ...
        AlertUtils.showNormalAlert(this, getString(R.string.tips_delete_file), getString(R.string.act_delete), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (FileUtils.deleteFile(fileItem.getPath())) {
                    ...
                    Subscription subscription = Observable.just(mFileListModel.getVideoList("", getContentResolver()))
                            .subscribeOn(Schedulers.io())
                            .observeOn(AndroidSchedulers.mainThread())
                            .subscribe(new Subscriber<ArrayList<FileItem>>() {
                                @Override
                                public void onStart() {
                                    AlertUtils.showToast(VideoBrowserActivity.this, getString(R.string.tips_delete_successfully));
                                ...
                                public void onError(Throwable e) {
                                    AlertUtils.showToast(VideoBrowserActivity.this, getString(R.string.tips_error));
                                    onCompleted();
                                }
                                ...
                                public void onNext(ArrayList<FileItem> fileItemList) {
                                    ...
                                    mAdapter = new VideoPagerAdapter(VideoBrowserActivity.this, fileItemList, VideoBrowserActivity.this);
                                    mViewPager.setAdapter(mAdapter);
                                }
                            });
                    mRxManager.add(subscription);
                } else {
                    AlertUtils.showToast(VideoBrowserActivity.this, getString(R.string.tips_delete_in_error));
                }
            }
        });
    }
    ...
    public void onError(EasyVideoPlayer player, Exception e) {
        AlertUtils.showToast(VideoBrowserActivity.this, getString(R.string.tips_not_support));
    }
