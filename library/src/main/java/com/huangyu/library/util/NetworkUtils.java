...
public final class NetworkUtils {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) BaseApplication.getAppContext().getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
    }
    ...
    public static boolean isAvailableByPing() {
        ...
        boolean ret = result.mResult == 0;
        if (result.mErrorMsg != null) {
            LogUtils.logd(result.mErrorMsg);
        }
        if (result.mSuccessMsg != null) {
            LogUtils.logd(result.mSuccessMsg);
        }
        return ret;
    }
